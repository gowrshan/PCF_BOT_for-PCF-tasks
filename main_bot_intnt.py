...
def samplefunction():
    ...
    if request.method == 'POST':
        ...
        if userInput in greetings:
            ...
            with open("/home/ec2-user/recent_inbuilt_indent/Intent_new/test_new_bot/templates/inputdetails.yml", 'r') as st:
                data=yaml.load(st)
                print(data)
            ...
            with open("/home/ec2-user/recent_inbuilt_indent/Intent_new/test_new_bot/templates/inputdetails.yml", 'r') as st1:
                data1 = yaml.load(st1)
...
def popup_onclick():
   ...
   if request.method == 'POST':
        ...
        with open("/home/ec2-user/recent_inbuilt_indent/Intent_new/test_new_bot/templates/inputdetails.yml", 'w') as stream:
            da={}
